...
\end{equation}
en faisant apparaître l'énergie cinétique $E_{\mathrm{k}}=k^2/2$, la valeur moyenne du potentiel $\overline{V}$ et la \selfenergy\ $\Sigma(E,\mathbf{k})=\langle\mathbf{k}|\Sigma(E)|\mathbf{k}\rangle$. Cette dernière peut être décomposée sous la forme d'une série:
\begin{equation}
