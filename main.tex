...
% style de l'intérieure du document
% style de tous les environnements etc ...
\input{structure}
...
\doctoralschool{Physique en \^Ile-de-France}{564}
\specialty{Physique}
\date{29 Juin 2020}
...
\jurymember{1}{Bruno CESSAC}{INRIA}{Rapporteur}
\jurymember{2}{Peter LATHAM}{Gatsby  Computational  Neuroscience  Unit - UCL London}{Rapporteur}
\jurymember{3}{Wulfram GERSTNER}{Laboratory of Computational Neuroscience, EPFL}{Examinateur}
\jurymember{4}{Zhiaoping LI}{Sensory and Sensorimotor Systems, Max-Planck-Institut}{Examinatrice}
\jurymember{5}{Claire SERGENT}{Universit\'e Paris-Descartes}{Examinatrice}
\jurymember{6}{Gianluigi MONGILLO}{Institut de la Vision - CNRS}{Invit\'e}
\jurymember{7}{Jean-Pierre NADAL}{ Ecole Normale Sup\'erieure - EHESS}{Directeur de th\`ese}
...
\input{Chapters/Present_exp.tex}
