...
\usechapterimagetrue
\chapterimage{Fig/Localisation/header.pdf}
...
%\usechapterimagefalse
\chapterimage{Fig/Modif_exp/header.pdf}
\input{Chapters/Modif_exp.tex}
\usechapterimagetrue
\chapterimage{Fig/Speckle/header.pdf}
\input{Chapters/Speckle.tex}
%\usechapterimagefalse
%\stopcontents

%\part{Temps de diffusion élastique}
\chapterimage{Fig/TauS_PRL/header.pdf}
\input{Chapters/Taus_PRL.tex}
%\usechapterimagetrue
\chapterimage{Fig/TauS_NJP/header.pdf}
