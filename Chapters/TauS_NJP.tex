...
\section{Conclusion}
étude dans le régime classique

confrontation des 2 approches, approche temporelle naturelle et approche spectrale avec le concept général des fonctions spectrales.

ordre 2.

Une diffusion unique, tout marche bien, on comprend bien avec l'aide d'un temps heuristique (taus)

Vers l'étude des propriétés de transport