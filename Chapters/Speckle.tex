...
On montre alors (voir annexe \ref{ch:anex_speckle}) que le profil d'intensité moyenne à la distance $d$ s'exprime comme étant le produit de convolution de deux termes
\begin{align}
...
\end{align}
décrivant respectivement la propagation du faisceau incident sous l'effet de la lentille et la diffraction par les grains du diffuseur. 


signification des deux termes

\begin{figure}
\centering

\caption{\textbf{Extension du champ de speckle.} L'extension du faisceau de speckle provient des effets toussa toussa...}
\label{fig:speckle_extension}
\end{figure}

Pour une zone très proche du plan focal de la lentille, le profil d'intensité lumineuse est alors décrit par 
\begin{equation}
