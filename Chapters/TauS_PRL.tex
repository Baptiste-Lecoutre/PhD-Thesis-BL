...
\begin{equation}
C(\Delta \mathbf{r})=\VR^2 e^{-\Delta\mathbf{r}^2/\sigmap^2}
\label{eq:correlation_2D_taus}
\end{equation}


\begin{equation}
\frac{1}{\taus^{\mathrm{Born}} }=\frac{\pi}{\hb} \frac{\VR^2}{\ER} e^{- k_{\mathrm{i}}^2 \sigmap^2 /2} \mathrm{I_0}(k_{\mathrm{i}}^2 \sigmap^2 /2)
\label{eq:taus_born_2D}
\end{equation}

\begin{equation}
\taus^{\mathrm{Born}} (k_{\mathrm{i}},\VR)=\frac{\hb\ER}{\pi \VR^2} \widetilde{\tau}_{\mathrm{s}}^{\mathrm{Born}} (k_{\mathrm{i}})
\end{equation}
