...
\hline
Courant seuil Biais A & $< \SI{1}{\milli\ampere}$ \\
\hline
Courant seuil Biais B & \SI{0.345}{\ampere} \\
\hline
...
\end{tabular}
\end{center}
\caption{Calibration des champs de biais dans la chambre de science.}
...
Il est primordial que les atomes se trouvent au centre de la lévitation car il s'agit de l'endroit où le champ magnétique est le plus homogène, et cette condition est d'autant plus importante alors nous nous orientons vers des lévitations à bas champ. En effet, c'est dans ce régime de bas champ que le piégeage de la lévitation est le plus important.
