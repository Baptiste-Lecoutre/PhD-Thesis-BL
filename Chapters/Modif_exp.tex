...
Pour cela, l'estimation du profil de faisceau se fait à l'aide de sa divergence après la cellule. 
Tailles estimée à 160*80µm. 
\begin{equation}
\mathrm{w}(y)=\mathrm{w}_{\mathrm{z}} \sqrt{1+\left( \frac{y}{y_{\mathrm{Rz}}} \right)^2}
\end{equation}
avec la distance de Rayleigh
\begin{equation}
y_{\mathrm{Rz}}=\frac{\pi \mathrm{w}_{\mathrm{z}}^2}{\lambda}
\end{equation}
