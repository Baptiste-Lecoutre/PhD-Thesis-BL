...
Comme mentionné précédemment, il existe une limite pour les fréquences de piégeage (formule \ref{eq:theoreme_wing}) qui décroît avec la norme du champ magnétique. Une stratégie usuelle est donc de créer un champ aussi fort que possible, qui est d'environ \SI{2000}{\gauss} avec notre système. Pour de tels champs, le potentiel magnétique n'est plus décrit par l'effet Zeeman linéaire, mais par la formule de Breit-Rabi \ref{eq:Breit-Rabi}. En revanche, pour une petite zone autour du centre de la lévitation, on peut simplifier l'étude en supposant que le champ change peu $B\simeq B_0$. On peut ainsi définir un facteur de Landé local
\begin{equation}
...
\caption{\textbf{Oscillation du nuage dans la lévitation magnétique.} Le nuage, initialement dans le piège optique, est relâché sur le bord de la lévitation. Il acquiert alors un mouvement oscillatoire autour du centre de la lévitation. \textbf{\'Evolution des fréquences de piégeage de la lévitation.} Blabla description de l'évolution des fréquences.}
...
Si pour le système isolé de lévitation magnétique le centre du potentiel magnétique correspond au centre géométrique des bobines, ce n'est plus le cas en présence d'un champ extérieur.

Déplacement du centre de la lévitation par les champs rémanents. On utilise alors des champs de compensation afin de replacer le centre de la lévitation au niveau des atomes pour éviter que le nuage oscille après relachment du piège optique.

\begin{equation}
B_{\mathrm{i}}=b_{\mathrm{0,i}}+c_{\mathrm{i}} \times I_{\mathrm{i}}
\end{equation}
où $i=\lbrace x,z \rbrace$
...
\end{equation}
et la présence d'un champ de biais dans le plan horizontal mène alors à un déplacement du centre de la lévitation
\begin{equation}
z_c =-\frac{2B_z}{b'}\left( \frac{1}{1-4B_0 b'' /b'^2} \right)
\end{equation}
pour un champ $B_z \ll B_0$ et où $z_c$ est la coordonnée du centre de la lévitation dans la direction $\vec{z}$
