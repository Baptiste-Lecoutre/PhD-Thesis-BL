...
\paragraph*{Bilan d'énergie}

Paramètre de troncature $\eta$ défini par
\begin{equation}
\eta=\frac{U}{\kB T}
\end{equation}
qui est constant et de l'ordre de 10 pour un piège optique.

Le piège change au cours de l'évaporation, et les variations d'énergie potentielle sont caractérisées par le paramètre $\nu$ défini par
\begin{equation}
\nu=\frac{\dot{\overline{\omega}}/\overline{\omega}}{\dot{U}/U}
\end{equation}
où $\overline{\omega}$ est la fréquence moyenne du piège.

L'énergie totale du gaz est donnée par
\begin{equation}
E=3N\kB T
\end{equation}

La variation d'énergie du gaz en cours d'évaporation est donnée par 
\begin{equation}
\dot{E}=\dot{N}(U+\alpha \kB T) +\nu\frac{\dot{U}}{U}E
\end{equation}
où le premier terme décrit la perte d'énergie liée à la perte d'atomes et le second terme décrit le changement d'énergie potentielle des particules dans le piège.

\begin{equation}
D=N\left(\frac{\hb \overline{\omega}}{\kB T}\right)^3
\end{equation}
