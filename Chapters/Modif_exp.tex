...
Dans cette partie, nous présenterons dans un premier temps notre système de lévitation ainsi que les modifications qui y ont été apportées. Ensuite, nous nous pencherons sur les méthodes utilisées pour calibrer le système après sa réinstallation sur l'expérience, en commençant par des expériences d'oscillations puis à l'aide de transitions radio-fréquences.
...
\end{equation}
obtenu à l'aide d'un développement limité de la formule de Breit-Rabi. La physique derrière cette approche est de considérer l'effet Zeeman linéaire sur un état dont la réponse dépend du champ de Biais $\Bzero$. 


La valeur du gradient nécessaire pour compenser la gravité peut alors être donnée par
\begin{equation}
...
Ces supports, disposés de part et d'autre de la cellule, comportent chacun trois bobines. 
...
\subsection{\'Etude du potentiel magnétique}
