...
\end{equation}
où $R=\dot{N}_{\mathrm{3b}}/\dot{N}_{\mathrm{tot}}$ est la fraction d'atomes perdus par collisions à trois corps. 
...
Cette étude est limitée aux premières \SI{700}{\milli\second} de l'évaporation, correspondant au temps nécessaire pour franchir le seuil $\mathcal{D}\approx 1$ de l'obtention d'un gaz dégénéré.



Evolution de du nombre d'atomes au cours de l'évaporation. On peut évaluer la fraction de pertes à trois corps en calculant la perte totales d'atomes et le taux de pertes à trois corps, obtenu par une mesure de la densité au centre du nuage. On obtient R de l'ordre de 0.1. On compare la prédiction de l'équation \ref{eq:scaling_atomes_3corps} avec $\eta=10$, qui fournit un bon accord avec les données. 
...
\caption{\textbf{Évolution du nombre d'atomes au cours de l'évaporation.} Points bleus = mesures, ligne noire = prédiction de la loi d'échelle \ref{eq:scaling_atomes_3corps} où le seul paramètre ajustable est le nombre d'atomes initial.}
