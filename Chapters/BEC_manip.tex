...
C'est dans la première chambre que se déroulent les premières étapes de refroidissement. 

\paragraph*{Refoidrissement laser}
bousin avec l'effet doppler, l'effet zeeman, toussa.
\begin{figure}
\centering
\includegraphics[width=0.8\textwidth]{Fig/BEC_manip/table_optique.pdf}
\caption{Les lasers de tes morts}
