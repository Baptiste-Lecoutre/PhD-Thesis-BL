...
\hline
Intensité de saturation & $I_{\mathrm{sat}}$ & 1.66mW.cm${}^{-2}$ \\
\hline
...
Le premier terme est proportionnel à la partie réelle de la polarisabilité atomique. Ce terme décrit donc comment un moment dipolaire électrique induit interagit avec son champ polarisateur. 

Cas d'un faisceau laser très désaccordé polarisé linéairement, tel qu'on ne résout pas la structure hyperfine de la transition. On ne voit pas la différence entre la $D_1$ et la $D_2$.
\begin{equation}
U_{\mathrm{dip}}(\mathbf{r})=\frac{3\pi c^2 I(\mathbf{r})}{2 \omega_0^3} \left( \frac{\Gamma}{\omega - \omega_0} - \frac{\Gamma}{\omega + \omega_0} \right)
\end{equation}
\begin{equation}
\Gamma_{\mathrm{sp}}=\frac{3 \pi c^2 I(\mathbf{r})}{2\hb \omega_0^3} \left( \frac{\omega}{\omega_0}\right)^3 \left( \frac{\Gamma}{\omega-\omega_0}-\frac{\Gamma}{\omega+\omega_0} \right)^2
\end{equation}
...
Le second terme s'appelle \emph{force de pression de radiation}. Il provient de la partie imaginaire de la polarisabilité atomique, qui caractérise l'absorption des atomes. 
\begin{equation}
s=\frac{I/I_{\mathrm{sat}}}{1+4(\omega-\omega_0)^2/\Gamma^2}
\end{equation}
\begin{equation}
I_{\mathrm{sat}}=\frac{\pi h c \Gamma}{3\lambda_0^3}
\end{equation}
\begin{equation}
