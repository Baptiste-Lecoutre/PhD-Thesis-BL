...
\begin{equation}
N_{\mathbf{n}}=g_{\mathbf{n}} \exp{\left( -(E_{\mathbf{n}}-\mu)/\kB T \right)}
\end{equation}
...
\begin{equation}
N_{\mathbf{n}}=\frac{g_{\mathbf{n}}}{\exp{\left( (E_{\mathbf{n}}-\mu)/\kB T \right)}-1}
\end{equation}
...
\begin{equation}
N_e(\mu,T)=\sum_{\mathbf{n}\neq\mathbf{0}} N_{\mathbf{n}} \leq \sum_{\mathbf{n} \neq \mathbf{0}} \frac{g_{\mathbf{n}}}{\exp{\left( (E_{\mathbf{n}}-E_{\mathbf{0}})/\kB T \right)}-1}
\end{equation}
...
\begin{equation}
\ldb=\sqrt{\frac{2\pi \hb^2}{m \kB T}}
\end{equation}
...
\begin{equation}
T_{\mathrm{C}}\sim \frac{\hb \overline{\omega}}{\kB}N^{1/3}
...
\begin{equation}
\mu=\frac{1}{2} \left( 15a \Nzero \hb^2 \overline{\omega}^3 \right) ^{2/5} m^{1/5}
\end{equation}
...
E_{F=1} &= - \frac{h \deltahf}{2} \sqrt{1+ m_F \beta +\beta^2}
\end{aligned}
\label{eq:Breit-Rabi}
\end{equation}
...
\begin{equation}
U_{\mathrm{mag}} (\mathbf{r}) = \mf g_{\mathrm{F}} \mub \left| B(\mathbf{r}) \right|
\end{equation}
