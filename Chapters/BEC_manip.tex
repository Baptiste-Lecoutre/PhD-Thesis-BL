...
\end{pmatrix}
\end{equation}
avec $\delta=\omega- \Delta_{\mathrm{hf}}$. En supposant que à $t=0$ le système est dans l'état $\left| F=1 \right\rangle$, la probabilité d'avoir l'atome dans l'état $\left| F=2 \right\rangle$ est donnée par la formule de Rabi \citep{basdevant2002mecanique}
\begin{equation}
