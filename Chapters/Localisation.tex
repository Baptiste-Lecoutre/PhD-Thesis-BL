...
\lipsum[5]
%\section{Etudes de la localisation d'Anderson}
%\subsection{Théorie d'échelle de la localisation d'Anderson}
%\subsection{Etude à basse dimensionnalité}
%\subsection{Etude à trois dimensions}
...
\section{Théorie d'échelle de la localisation d'Anderson}
\subsection{Critère de Thouless}
\subsection{Importance de la dimensionnalité}
\subsection{Théorie auto-consistante de la localisation d'Anderson}

\section{Expériences de localisation}
\subsection{Observation d'effets de localisation faible}
\subsection{Expériences sur la localisation d'Anderson}
%\subsection{Vers l'étude du régime critique}
\end{comment}
