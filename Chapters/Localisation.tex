...
graphe de Delande, renormalisation par l'énergie de corrélation anisotrope


\begin{equation}
\ER=\frac{\hb^2}{m\overline{\sigma}^2} \quad \text{avec} \quad \overline{\sigma}={(\sigma_x \sigma_y \sigma_z)}^{1/3}
\end{equation}
...
\caption{\textbf{Comparaison des résultats expérimentaux à des simulations numériques.} Stuff.}
