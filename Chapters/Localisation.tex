...
Ce n'est que récemment (2020) que ces contraintes ont pu être contournées grâce à l'utilisation d'un désordre optique généré par un modulateur spatial de lumière, permettant de contrôler le seuil de percolation. White et al. \citep{white2020observation} rapportent ainsi l'observation de la localisation d'Anderson en deux dimensions avec des atomes ultra-froids à l'aide d'une expérience de transmission entre deux réservoirs connectés par un canal désordonné. Les auteurs interprètent l'allure exponentielle de la fonction d'onde dans le canal désordonné comme une signature de la localisation d'Anderson, et étudient le comportement de la longueur de localisation associée en fonction de la densité de diffuseurs dans le canal, ainsi que pour plusieurs géométries de ce dernier.
